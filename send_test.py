...
try:
    with smtplib.SMTP('localhost', 1025) as s:
        for i, scenario in enumerate(scenarios, 1):
            ...
            msg['To'] = scenario.get("to", "suporte@replyme.local")
