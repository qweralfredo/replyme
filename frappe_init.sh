...
bench set-mariadb-host helpdesk_mariadb
bench set-redis-cache-host redis://helpdesk_redis:6379
bench set-redis-queue-host redis://helpdesk_redis:6379
bench set-redis-socketio-host redis://helpdesk_redis:6379
